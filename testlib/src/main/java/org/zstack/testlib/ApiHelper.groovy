...
trait ApiHelper {
    ...
    def getIAM2RoleTemplate(@DelegatesTo(strategy = Closure.OWNER_FIRST, value = org.zstack.sdk.iam2.api.GetIAM2RoleTemplateAction.class) Closure c) {
        def a = new org.zstack.sdk.iam2.api.GetIAM2RoleTemplateAction()
        a.sessionId = Test.currentEnvSpec?.session?.uuid
        c.resolveStrategy = Closure.OWNER_FIRST
        c.delegate = a
        c()
