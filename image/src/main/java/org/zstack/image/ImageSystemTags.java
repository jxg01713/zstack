...
public class ImageSystemTags {
    ...
    public static String APPCENTER_RAW_TOKEN = "rawapp";
    public static PatternedSystemTag APPCENTER_RAW = new PatternedSystemTag(String.format("rawapp::{%s}", APPCENTER_RAW_TOKEN), ImageVO.class);
